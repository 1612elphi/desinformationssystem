...
COPY db.py scraper.py filestore.py oparl.py seed.py backfill_pdfs.py enrich.py submitter.py vote_parse.py ticker.py web.py mcp_server.py entrypoint.sh ./
